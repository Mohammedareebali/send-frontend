...
import { User, Calendar, MapPin, Mail, Phone, FileText, Truck, Tag } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Card className="bg-white shadow-md hover:shadow-lg transition-shadow duration-300 sm:col-span-2">
                ...
                <CardContent className="space-y-2">
                  <InfoItem icon={FileText} label="National Insurance" value={driver.nationalInsuranceNumber} />
                </CardContent>
              </Card>
            </div>
          </div>
